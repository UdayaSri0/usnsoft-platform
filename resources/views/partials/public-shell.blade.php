...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="relative min-h-screen overflow-x-hidden">
            <div class="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,_rgba(14,116,144,0.14),_transparent_32%),radial-gradient(circle_at_top_right,_rgba(37,99,235,0.12),_transparent_38%),linear-gradient(180deg,_#f8fbfd,_#eef4f8_46%,_#eef3f9)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.18),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(20,184,166,0.12),_transparent_30%),linear-gradient(180deg,_#020617,_#06111c_46%,_#0b1725)]"></div>

            <header x-data="{ open: false }" class="sticky top-0 z-40 border-b border-slate-200/80 bg-white/80 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/80">
                <div class="usn-container-wide flex min-h-[5rem] items-center justify-between gap-4">
                    <a href="{{ route('home') }}" class="flex items-center gap-3">
                        ...
                        <span>
                            <span class="block font-display text-lg font-semibold tracking-tight text-slate-950 dark:text-slate-100">USNsoft</span>
                            <span class="block text-xs font-medium uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Secure Platform Delivery</span>
                        </span>
                    </a>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button
                            type="button"
                            class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-300 bg-white text-slate-700 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300 lg:hidden"
            ...
            <footer class="mt-16 border-t border-slate-200/80 bg-white/70 backdrop-blur dark:border-slate-800/80 dark:bg-slate-950/70">
                <div class="usn-container-wide grid gap-10 py-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-display text-lg font-semibold text-slate-950 dark:text-slate-100">USNsoft Platform</span>
                        </div>
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Navigate</p>
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Policies</p>
                        <div class="mt-4 grid gap-2 text-sm">
                ...
                <div class="border-t border-slate-200/80 bg-white/60 dark:border-slate-800/80 dark:bg-slate-950/60">
                    <div class="usn-container-wide flex flex-col gap-2 py-4 text-sm text-slate-500 dark:text-slate-400 sm:flex-row sm:items-center sm:justify-between">
