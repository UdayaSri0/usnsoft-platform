...
use App\Modules\AuditSecurity\Policies\FailedLoginAttemptPolicy;
...
use App\Modules\IdentityAccess\Policies\MfaMethodPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(FailedLoginAttempt::class, FailedLoginAttemptPolicy::class);
        Gate::policy(SecurityEvent::class, SecurityEventPolicy::class);
        Gate::policy(AuditLog::class, AuditLogPolicy::class);
        Gate::policy(MfaMethod::class, MfaMethodPolicy::class);
